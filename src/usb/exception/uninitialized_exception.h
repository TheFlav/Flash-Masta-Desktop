 ...
 *         \ref usb::uninitialized_exception class.
 *  
 *  File containing the header information and declaration of the
 *  \ref usb::uninitialized_exception class. This file includes the minimal
...
#ifndef __USB_UNINITIALIZED_EXCEPTION_H__
#define __USB_UNINITIALIZED_EXCEPTION_H__
 ...
 *         \ref usb::usb_device was not initialized before an operation was
 *         attempted on it.
 *  
 *  Subclass of \ref usb::exception that indicates that a \ref usb::usb_device
 *  was not initialized before an operation was attempted on it. Provides member
...
public:
   ...
   *         uninitialized before an operation was performed on the device.
   *  
   *  Gets the name provided during construction of the class that was
   *  uninitialized before an operation was performed on the device.
   *  
...
#endif /* defined(__USB_UNINITIALIZED_EXCEPTION_H__) */
